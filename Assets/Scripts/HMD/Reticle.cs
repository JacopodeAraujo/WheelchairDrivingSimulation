...
namespace VRStandardAssets.Utils {
    ...
    public class Reticle : MonoBehaviour {
        ...
        //[SerializeField] private SelectionRadial m_SelectionRadial;     // The Selection radial progress
        ...
        public void reticleColorHit(bool onHit) {
            Color c;
            if (onHit)
                c = Color.green;
            else c = Color.red;
        ...
        public void SetPosition(Vector3 origin, Vector3 direction, float distance) {
            // Set the position of the reticle to the default distance in front of the camera.
            //m_ReticleTransform.position = m_Camera.position + m_Camera.forward * m_DefaultDistance;
            m_ReticleTransform.position = origin + direction * 5f;

            // Set the scale based on the original and the distance from the camera.
            m_ReticleTransform.localScale = m_OriginalScale * 5f;
